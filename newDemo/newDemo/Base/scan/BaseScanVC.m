...
#pragma mark - 设计扫描背景
-(void)setScanningBG{
    UIImageView * scanImg = [UIImageView imageViewWithFrame:CGRectMake(ScreenW/2-130, (MainNoTabBarHight)/2-130, 260, 260) imageName:@"扫码框" contentMode:0];
    [self.view addSubview:scanImg];
    
    //画中间的基准线
    _QrCodelineImg = [UIImageView imageViewWithFrame:CGRectMake(ScreenW/2-130, (MainNoTabBarHight)/2-130, 260, 5) imageName:@"线" contentMode:0];
    [self.view addSubview:_QrCodelineImg];
    
    UIView *tempView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, ScreenW, MainNoTabBarHight)];
    ...
    [UIView animateWithDuration:2 animations:^{
        self->_QrCodelineImg.frame = CGRectMake(ScreenW/2-130, (MainNoTabBarHight)/2+125, 260, 5);
    }];
    //开启定时器
...
- (void)initScanningContent{
    ...
    layer.frame = CGRectMake(0, 0, ScreenW, MainNoTabBarHight);
...
- (void)moveUpAndDownLine
{
    ...
    if (YY == (MainNoTabBarHight)/2+125) {
        [UIView animateWithDuration:2 animations:^{
            self->_QrCodelineImg.frame = CGRectMake(ScreenW/2-130, (MainNoTabBarHight)/2-130, 260, 5);
        }];
    }else {
        [UIView animateWithDuration:2 animations:^{
            self->_QrCodelineImg.frame = CGRectMake(ScreenW/2-130, (MainNoTabBarHight)/2+125, 260, 5);
